...
<#if section = "title">
    ...
    <div class="custom-wrapper">
        <div class="custom-grid">
            ...
            Election Commission Login Page
                            ...
                            <div id="usePasswordDiv" class="mw-100" >
                                <form id="kc-form-login" onsubmit="return encryptPassword(); login.disabled = true; return true;" class="ui form" method="POST" action="${url.loginAction}">
                                    ...
                                    <div class="field">
                                        ...
                                        <#else>
                                        <input class="mt-8" id="username" name="username" onkeyup="validateEmailChar()" onfocusin="inputBoxFocusIn(this)" onfocusout="inputBoxFocusOut(this)" type="text" autofocus autocomplete="off" maxLength=96 />
                            ...
                            <div id="useOTPDiv" class="mw-100" style="display:none">
                                <form id="kc-form-login" class="${properties.kcFormClass!} ui form" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                                    ...
                                    <div class="field">
                                        ...
                                        name="emailOrPhone" type="text" autofocus autocomplete="off" onfocusin="inputBoxFocusIn(this)" onfocusout="inputBoxFocusOut(this)" maxlength=96>
                                    </div>
